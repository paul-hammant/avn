...
int path_is_ancestor_of_glob(const char*, const char*);
int subtree_glob_matches(const char*, const char*);
int path_matches_glob(const char*, const char*);
...
// Extern C function: svnae_fnmatch_pathname
int svnae_fnmatch_pathname(const char*, const char*);

int path_is_ancestor_of_glob(const char* path, const char* glob) {
int pn = string_length(path);
int gn = string_length(glob);
if (pn >= gn) {
        {
            return 0;
        }
    }
if (string_char_at(glob, pn) != 47) {
        {
            return 0;
        }
    }
...
while (i < pn) {
        {
if (string_char_at(path, i) != string_char_at(glob, i)) {
                {
                    return 0;
                }
            }
...
int subtree_glob_matches(const char* path, const char* glob) {
int gn = string_length(glob);
if (gn < 3) {
        {
            return 0;
...
if (string_char_at(glob, (gn - 3)) != 47) {
        {
            return 0;
        }
    }
if (string_char_at(glob, (gn - 2)) != 42) {
        {
            return 0;
        }
    }
if (string_char_at(glob, (gn - 1)) != 42) {
        {
            return 0;
        }
    }
...
if (string_char_at(path, plen) == 47) {
        {
            return 1;
        }
    }
...
int path_matches_glob(const char* path, const char* glob) {
if (subtree_glob_matches(path, glob) == 1) {
        {
            return 1;
        }
    }
if (svnae_fnmatch_pathname(glob, path) == 1) {
        {
            return 1;
        }
    }
if (path_is_ancestor_of_glob(path, glob) == 1) {
        {
            return 1;
        }
    }
...
// Exported:
int spec_path_matches_glob(const char* path, const char* glob) {
    return path_matches_glob(path, glob);
}

// Exported:
int spec_matches_any(const char* path, const char* specs_joined) {
int pn = string_length(path);
if (pn == 0) {
        {
            return 0;
...
int sn = string_length(specs_joined);
if (sn == 0) {
        {
            return 0;
        }
...
if (i < sn) {
                {
c = string_char_at(specs_joined, i);
                }
            }
if (i == sn) {
                {
if (i > start) {
                        {
glob = string_substring(specs_joined, start, i);
if (string_length(glob) > 0) {
                                {
if (path_matches_glob(path, glob) == 1) {
                                        {
                                            return 1;
                                        }
                                    }
...
int32_t aether_path_is_ancestor_of_glob(const char* path, const char* glob) {
    return path_is_ancestor_of_glob(path, glob);
}
int32_t aether_subtree_glob_matches(const char* path, const char* glob) {
    return subtree_glob_matches(path, glob);
}
int32_t aether_path_matches_glob(const char* path, const char* glob) {
    return path_matches_glob(path, glob);
}
int32_t aether_spec_path_matches_glob(const char* path, const char* glob) {
    return spec_path_matches_glob(path, glob);
}
int32_t aether_spec_matches_any(const char* path, const char* specs_joined) {
    return spec_matches_any(path, specs_joined);
}
