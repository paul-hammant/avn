...
// Exported:
const char* blobfield_get(const char* body, const char* key) {
int n = string_length(body);
int klen = string_length(key);
if (n == 0) {
        {
            return "";
        }
...
if ((i + klen) < n) {
                {
if (string_char_at(body, (i + klen)) == 58) {
                        {
is_match = 1;
j = 0;
while (j < klen) {
                                {
if (string_char_at(body, (i + j)) != string_char_at(key, j)) {
                                        {
is_match = 0;
                                            break;
                                        }
...
e = (e + 1);
                                    ...
                                    return string_substring(body, v, e);
                                }
                            }
                        }
                    }
...
const char* aether_blobfield_get(const char* body, const char* key) {
    return blobfield_get(body, key);
}
